...
This is a .net 5 project, so as long as you have the dotnet cli, available [here](https://dotnet.microsoft.com/download/dotnet/7.0) you should be able to do the following: `dotnet build ./cli`
