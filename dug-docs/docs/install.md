...
1. Go to the [latest release](https://git.unfrl.com/Unfrl/dug/releases/latest) and download the .deb package.
...
1. Go to the [latest release](https://git.unfrl.com/Unfrl/dug/releases/latest) and download the .rpm package.
